...
実験のために、一人のトラブルシューターが箱を持ち、一人以上のトラブルシューターが攻撃役として割り当てられ、警棒とコーンライフル(スラッグ弾、ダムダム弾、榴弾、徹甲弾、HEAT弾)を渡され、バンカーの外に出る。

機能試験のために、「ストーン」を入手することが指示される。ストーンはテストルーム内に常備されていると伝えられる。

試験内容：警棒で殴る、ストーンを投げる。コーンライフルで射つ
